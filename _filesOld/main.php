...
<body>
    <header id="cabecalho">
        <nav id="navegacao">
           ...
           <div id="logout-div">
               <div id="usuario">
                    <p id="cumprimentos">Olá, <?php echo $_SESSION['user'];?></p>
               </div>
                <div id="log-out">
                    <a id="sair" href="logout.php">Terminar sessão<img src="_imagens/logout.png" alt="Sair"></a>
                </div>   
           </div> 
        </nav>
    </header>
    <aside id="aside">
        <div id="Avatar">
            ...
            <label for="nome">Usuário: <?php echo $_SESSION['user'] ?></label>  
        </div>
    </aside>
    <div id="container">
