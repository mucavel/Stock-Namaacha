        ...
        <div id="navbar">
            <nav id="navegacao">
                ...
                <div id="nav-container">
                    <div id="boasvindas">
                        <p>Olá, Admin. <?php echo $_SESSION['admin'] ?></p>
                    </div>
                    <div id="sair">
                        <a href="logoutadm.php">Terminar sessão</a><img src="_imagens/logout.png" alt="Terminar sessão">
                    </div>
                </div>
            </nav>
        </div>
    ...
    <section id="container">
        <div class="container">
            ...
            <div id="registros">
                ...
                ?>
                    <td>
                        <a id="apagar" href="stockadm.php?idGarraf=<?php echo $dados[$i]['idGarraf'];?>">Apagar</a>
                    </td>   
                <?php        
                        echo "</tr>";
                        }
